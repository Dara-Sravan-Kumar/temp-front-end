...
function App() {
  ...
  <AppContext.Provider value={{ users, dispatchUserEvent }}>
    ...
    <Routes>
      ...
      {/* <Route path='/adminDashboard' element={<PrivateRoute><Signin /></PrivateRoute>} /> */}
      <Route path='/dashboard' element={<PrivateRoute><StudentDashboard /></PrivateRoute>}/>
      <Route path='/Student/Editprofile' element={<PrivateRoute><Editprofile /></PrivateRoute>} />
      <Route path='/Student/ViewUser' element={<PrivateRoute><ViewUser/></PrivateRoute>}/>
      <Route path='/Student/Changepswd' element={<PrivateRoute><Changepswd/></PrivateRoute>}/>
      <Route path='/Student/Hostelpage' element={<PrivateRoute><Hostelpage/></PrivateRoute>}/>
      <Route path='/Student/Roompage' element={<PrivateRoute><Roompage/></PrivateRoute>}/>
      <Route path='/Student/Roomrequest' element={<PrivateRoute><Roomrequest/></PrivateRoute>}/>
      <Route path='/Student/Studenthome' element={<PrivateRoute><Studenthome/></PrivateRoute>}/>
